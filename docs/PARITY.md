...
| Device I/O: **bidirectional USB MIDI Bridge** (virtual "LF+ IN PORT/ LF+ OUT PORT" ↔ device) | ✅ | 🔌 | needs bidirectional Web MIDI ↔ WebSerial forwarding; deferred (desktop-only for now) |
